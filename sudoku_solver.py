...
class SudokuSolver(object):
    ...
    def solve(self):
        ...
        # return
        iterations = 0
        while self.solved() is False and iterations < 100:
            iterations += 1
    ...
    def solve_quadrants(self):
        ...
        # In each quadrant
        #    for each pending no
        #       maintain acceptable count
        #       for each position 
        #           if its an acceptable match, increment the count
        #       if acceptable count is 1 -> assign the no to that position
        ...
        for k in range(9):
            ...
            while p < len(pending_numbers):
                ...
                if len(acceptable_matches) == 1:
                    ...
                    # pending_numbers.remove(pending_number)
                    # # print 'rOW pending ' + str(self.rows[x]["pending_numbers"])
